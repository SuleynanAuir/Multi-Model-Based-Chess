...
depth = 0
engine = chess.engine.SimpleEngine.popen_uci(r"stockfish\stockfish\stockfish-windows-x86-64-avx2.exe")
...
def rollout(curr_node):
    ...
    result = engine.play(curr_node.state, chess.engine.Limit(time=0.0000001))
